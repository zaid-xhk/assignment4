...
function  funct_ion(array:number[],index:number) {
    array.splice(2,1)    
    console.log(array);
    
    return array
}
var newFuction:number[] = funct_ion([5,4,3,2,1],54);
...
function addItems(shopping_cart:string[]) {
    shopping_cart.splice(4,1,"tooth_paste")
    console.log(shopping_cart);
    
}
// var shopping_cart:string []=["flour","sugar","salt","water", "soup"];
function removeItems(shopping_cart:string[]) {
    shopping_cart.splice(4,1);
    console.log(shopping_cart);
}

// var shopping_cart:string []=["flour","sugar","salt","water", "soup"];
function updateItems(shopping_cart:string[]) {
...
function factorial(num:number) {
    while(num=4){
   var factorial1:number = num * (num - 1) * (num - 2) * (num - 3)
...
var arrayNum:number[] =[4,-7,8,9,-12,14] 
...
var tempratureList:any []=[35,37,38,39,40] ;
